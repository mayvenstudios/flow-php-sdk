# Contributing to the Flow JVM SDK

The following is a set of guidelines for contributing to the Flow PHP SDK.
...
Unsure where to begin contributing to the Flow JVM SDK?
You can start by looking through these `good-first-issue` and `help-wanted` issues:

- [Good first issues](https://github.com/mayvenstudios/flow-php-sdk/labels/good%20first%20issue):
  issues which should only require a few lines of code, and a test or two.
- [Help wanted issues](https://github.com/mayvenstudios/flow-php-sdk/labels/help%20wanted):
...
Please follow the [PSR-4 coding conventions](https://www.php-fig.org/psr/psr-4/)
when contributing code to this repository.

## Additional Notes

Thank you for your interest in contributing to the Flow PHP SDK!
